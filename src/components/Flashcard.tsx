...
export const Flashcard: React.FC<FlashcardProps> = ({ word, definition, needsPractice = false, onTogglePractice }) => {
  ...
  return (
    ...
    >
      ...
      >
        {/* Front (Word) */}
        <div 
          className={`absolute inset-0 h-full w-full bg-white rounded-xl shadow-sm border ${needsPractice ? 'border-yellow-400 ring-2 ring-yellow-100' : 'border-gray-200'} flex flex-col items-center justify-center p-4 text-center transition-all`}
        ...
        >
          ...
          <button 
            ...
            title={needsPractice ? "Verwijder uit oefenlijst" : "Markeer voor oefenen"}
          >
            <svg 
              xmlns="http://www.w3.org/2000/svg" 
              viewBox="0 0 24 24" 
              fill={needsPractice ? "#FBBF24" : "none"} 
              stroke={needsPractice ? "#FBBF24" : "#D1D5DB"}
              strokeWidth={2}
        ...
        {/* Back (Definition) */}
        <div 
          className="absolute inset-0 h-full w-full bg-primary rounded-xl shadow-sm border border-primary flex flex-col items-center p-4 text-white"
          style={{ 
        ...
        >
          ...
          >
             <svg 
              ...
              viewBox="0 0 24 24" 
              fill={needsPractice ? "#FBBF24" : "none"} 
              stroke={needsPractice ? "#FBBF24" : "rgba(255,255,255,0.6)"}
              strokeWidth={2}
              className="w-6 h-6"
            >
              <path strokeLinecap="round" strokeLinejoin="round" d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.545.044.77.77.349 1.139l-4.25 3.663a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.25-3.663c-.42-.37-.196-1.095.349-1.139l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z" />
